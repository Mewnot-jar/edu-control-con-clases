...
registro_colegio = Colegio.Colegio()
#Cursos validos
cursos = registro_colegio.obtener_cursos()
    ...
    while True:
        ...
        match opcion:
            ...
            case "2":
                ...
                obtener_ficha_academica(rut_a_buscar)
            case "3":
...
def registrar_alumno():
    ...
    while True:
        ...
        if not rut:
            ...
            continue
        if registro_colegio.buscar_alumno_registro(rut):
    ...
    registro_colegio.agregar_registro(alumno)
...
def panel_alumno():
    ...
    #Lo buscamos
    alumno = registro_colegio.buscar_alumno_registro(rut_ingreso)
    ...
    if not alumno.password:
        ...
        gestionar_clave_alumno(alumno.rut)
    else:
    ...
    while True:
        ...
        match opcion:
            ...
            case "2":
                ...
                obtener_ficha_academica(alumno.rut)
                input("Pulsa ENTER para continuar...")
                continue
            case "3":
                #Generamos su certificado de matricula
                generar_certificado(alumno.rut)
                input("Pulsa ENTER para continuar...")
                continue
            case "4":
...
def obtener_ficha_academica(rut):
    ...
    alumno = registro_colegio.buscar_alumno_registro(rut)
    if alumno:
